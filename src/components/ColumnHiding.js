...
export const ColumnHiding = () => {
    ...
    return (
        ...
        <div>
            <div>
            {/* the react-table checkbox needs to be used as there is an indeterminate state for this particular checkbox */}
            {/* this takes car of toggling the visibility of all the columns */}
